 ...
 * 处理语言变更请求
 */
function handleLanguageChanged(message: any, sendResponse?: (response?: any) => void) {
 ...
 * 处理会议信息更新
 */
function handleMeetingInfoUpdate(message: any, sender: chrome.runtime.MessageSender, sendResponse?: (response?: any) => void) {
