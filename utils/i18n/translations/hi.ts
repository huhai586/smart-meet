export default {
  ...
  "select_language": "अनुवाद के लिए भाषा चुनें",
  "settings": "सेटिंग्स",
  ...
  "api_key_desc": "AI सुविधाओं को सक्षम करने के लिए अपनी Gemini API कुंजी दर्ज करें। आप Google AI Studio से API कुंजी प्राप्त कर सकते हैं।",
  "api_key_info": "AI कार्यों के लिए आसानी से उपयोग करने के लिए कृपया अपनी Gemini API कुंजी दर्ज करें।",
  "api_key_source": "आप API कुंजी प्राप्त कर सकते हैं",
  "enter_api_key": "Gemini API कुंजी दर्ज करें",
  ...
  "restore_section": "पुनर्स्थापित करें",
  "restore_desc": "Google ड्राइव से मीटिंग डेटा पुनर्स्थापित करें",
  "restore_button": "पुनर्स्थापित करें",
  "restore_all": "सभी पुनर्स्थापित करें",
  "refresh": "रीफ्रेश करें",
  "upload": "अपलोड करें",
  "delete": "हटाएं",
  "conflict_title": "विवाद समाधान",
  ...
  "search_for": "खोजें: {term}",
  "clear": "साफ़ करें",
  "no_matching_content": "कोई मिलान चैट सामग्री नहीं मिली",
  "no_matching_history": "कोई मिलान चैट इतिहास नहीं मिला",
  "no_chat_history": "कोई चैट इतिहास नहीं मिला",
  "chat_records": "चैट रिकॉर्ड - {date}",
  ...
  "domain_specific_highlights": "डोमेन-विशिष्ट हाइलाइट",
  "domain_specific_desc": "डोमेन-विशिष्ट शब्दावली और कीवर्ड के आधार पर हाइलाइटिंग कॉन्फ़िगर करें।",
  "current_domain_tags": "वर्तमान डोमेन टैग",
  "domain_placeholder": "अपना रुचि का डोमेन दर्ज करें",
  "keywords_placeholder": "उन कीवर्ड का वर्णन करें जिन्हें आप हाइलाइट करना चाहते हैं (जैसे तकनीकी शब्द, उद्योग शब्दावली)",
  "generate_keywords": "कीवर्ड जनरेट करें",
  "preview_keywords": "जनरेट किए गए कीवर्ड का पूर्वावलोकन करें",
