export default {
  ...
  "provider_local": "Lokale KI-Übersetzung",
  "provider_local_desc": "Chrome-integrierte KI, kein Internet erforderlich",
  "local_translator_title": "Lokaler KI-Übersetzer",
  "local_translator_checking": "Verfügbarkeit wird geprüft...",
  "local_translator_not_supported": "Auf diesem Gerät nicht unterstützt",
  "local_translator_not_supported_hint": "Erfordert Chrome 138+ auf dem Desktop mit GPU",
  "local_translator_downloading": "Übersetzungsmodell wird heruntergeladen...",
  "local_translator_download_progress": "{percent}% heruntergeladen",
  "local_translator_ready": "Modell bereit",
  "local_translator_test_title": "Übersetzung testen",
  "local_translator_input_placeholder": "Text zum Übersetzen eingeben...",
  "local_translator_output_placeholder": "Übersetzung erscheint hier...",
  "local_translator_translate_btn": "Übersetzen",
  "local_translator_done": "Lokale KI verwenden",
  "local_translator_source_lang": "Quelle",
  ...
  "active_service_changed": "Standarddienst geändert",
  "optional": "Optional",
  ...
  "tab_ai_models": "Dienstmodelle",
  "tab_ai_prompts": "Prompt-Bibliothek",
  "tab_translation_prefs": "Übersetzungseinstellungen",
  "tab_general": "Allgemein",
  "tab_general_desc": "Sprache, Schriftgröße, Hilfe und Datenverwaltung",
  "tab_interface": "Oberfläche",
  "tab_interface_desc": "Seitenleisten-Tabs, Untertitel-Schaltflächen, Meeting-Overlay und Hervorhebungen",
  "tab_history": "Kalender",
  "tab_history_desc": "Meeting-Verlauf, KI-Assistent und Export",
  "tab_cloud_sync": "Cloud-Speicher",
  "tab_cloud_sync_desc": "Google Drive Sicherung und Wiederherstellung",
  "meeting_history_tab": "Meeting-Verlauf",
  "ai_assistant_tab": "KI-Assistent",
  "ai_chat_title": "KI-Meetingassistent",
  "ai_chat_empty_desc": "Wählen Sie einen Zeitraum aus, um eine Konversation basierend auf den Meeting-Aufzeichnungen zu starten",
  "ai_reading_records": "Meeting-Aufzeichnungen werden gelesen",
  "ai_found_records": "{count} gefunden",

  // Popup (additional)
  "extension_name": "Smart Meet",
  "popup_subtitle": "Google Meet Erweiterungstool",
  "main_controls": "Hauptsteuerung",
  "quick_actions": "Schnellaktionen",
  "recommended": "Empfohlen",

  // AI Chat Panel - Date Range & Input
  "select_date_range": "Meetingdatumsbereich auswählen",
  "preset_3d": "Letzte 3 Tage",
  "preset_7d": "Letzte 1 Woche",
  "preset_14d": "Letzte 2 Wochen",
  "preset_1m": "Letzter 1 Monat",
  "preset_2m": "Letzte 2 Monate",
  "preset_3m": "Letzte 3 Monate",
  "preset_custom": "Benutzerdefiniert",
  "date_format_short": "D. MMM",
  "capsule_text": "{start} - {end} ({count} Einträge)",
  "clear_chat": "Chat löschen",
  "no_ai_provider_before": "Kein KI-Dienst konfiguriert, bitte",
  "no_ai_provider_link": "zu den KI-Einstellungen",
  "no_ai_provider_after": "gehen, um einen Anbieter einzurichten.",
  "placeholder_no_date": "Bitte zuerst einen Datumsbereich auswählen...",
  "placeholder_no_provider": "Bitte zuerst einen KI-Dienst konfigurieren...",
  "ai_input_placeholder": "Frage eingeben, Cmd+Enter oder Ctrl+Enter zum Senden",
  "select_ai_service": "KI-Dienst auswählen",
  "default_label": "Standard",
  "current_provider": "Aktuell: {name}",
  "select_ai": "KI auswählen",

  // Shared UI (General tab)
  "help_and_guide": "Hilfe & Anleitung",
  "open_welcome_guide": "Willkommensanleitung öffnen",
  "ui_language_selector_desc": "Sprache der Erweiterungsoberfläche wählen",
  "data_management": "Datenverwaltung",
  "highlight_words_section": "Untertitel-Highlights",

  // Options tabs
  "tab_ai_models_nav": "KI-Modelle",
  "tab_visibility": "Sichtbarkeit",
  "tab_translation": "Übersetzung",
  "tab_translation_nav": "Übersetzung",
  "tab_other": "Sonstiges",
  "tab_calendar": "Google Calendar",
  "tab_data_sync": "Meeting-Verlauf",
  "tab_google_drive": "Google Drive",
  // Extension section
  "extension_section": "Erweiterung",
  "enable_extension": "Erweiterung aktivieren",
  "extension_active_desc": "Untertitel-Aufzeichnung ist in Google Meet aktiv",
  "extension_paused_desc": "Erweiterung pausiert — keine Untertitel werden aufgezeichnet",
  "extension_toggle_footer": "Umschalten, um die Untertitel-Aufzeichnung zu pausieren oder fortzusetzen, ohne die Erweiterung zu deinstallieren.",

  // Popup tabs
  "popup_tab_meetings": "Meetings",
  "popup_tab_live": "Laufend",
  "popup_tab_ai": "KI",
  "popup_tab_settings": "Einstellungen",
  "ai_no_content_title": "Noch kein Meeting-Inhalt",
  "ai_no_content_sub": "Deine Meeting-Zusammenfassungen und KI-Einblicke erscheinen hier nach deinen Meetings.",
  "ai_whats_coming": "Was du erhalten wirst",
  "ai_feature_summaries": "KI-generierte Zusammenfassungen",
  "ai_feature_highlights": "Kernpunkte & Aktionspunkte",
  "ai_feature_ask_meetings": "Frag alles über deine Meetings",
  "ai_recent_meetings": "Letzte Meetings",
  "ai_ask_ai_btn": "KI fragen",
  "ai_view_all_meetings": "Alle Meetings & Zusammenfassungen ansehen",
  "meetings_connect_title": "Sieh deine bevorstehenden Google Meet-Meetings",
  "meetings_connect_sub": "Verbinde deinen Google Calendar, um bevorstehende Meetings zu sehen und Erinnerungen zu erhalten.",
  "meetings_connect_note": "🔒 Nur-Lesen-Zugriff. Deine Daten sind privat.",
  "meetings_no_upcoming_title": "Keine bevorstehenden Meetings",
  "meetings_no_upcoming_sub": "Dein Kalender ist leer. Genieße deinen Tag!",
  "meetings_open_calendar_settings": "Kalendereinstellungen öffnen",
  "meetings_today_label": "Heute · {date}",
  "meetings_synced_now": "Gerade synchronisiert",
  "meetings_sync_ago": "Vor {time} synchronisiert",
  "meetings_sync_h": "Std",
  "meetings_sync_m": "Min",
  "meetings_sync_s": "Sek",
  "meetings_in_progress": "Läuft gerade",
  "meetings_starts_in": "Beginnt in {min} Min",
  "meetings_untitled": "Unbenanntes Meeting",
  "meetings_participants": "{n} Teilnehmer",
  "meetings_join_btn": "Meeting beitreten",
  "meetings_later_today": "Später heute",
  "meetings_view_schedule": "Vollständigen Zeitplan anzeigen",
  "live_no_meeting_title": "Kein Live-Meeting erkannt",
  "live_no_meeting_sub": "Tritt einem Google Meet-Meeting bei, um Live-Untertitel und Übersetzungsstatus zu sehen.",
  "live_how_it_works": "Wie es funktioniert",
  "live_how_body": "Wir erkennen automatisch, wenn du in einem Google Meet bist, und beginnen mit der Aufzeichnung von Untertiteln.",
  "live_meet_detected": "Google Meet erkannt",
  "live_now": "Jetzt live",
  "live_captions_label": "Untertitel",
  "live_active": "Aktiv",
  "live_translation_label": "Übersetzung",
  "live_translation_active": "Aktiv (EN → {lang})",
  "live_off": "Aus",
  "live_open_panel_btn": "Live-Panel öffnen",
  "live_hint": "Übersetzung in den Einstellungen verwalten",
  "live_manage_settings": "In Einstellungen verwalten ›",

  // Settings tab
  "settings_open_full": "Vollständige Einstellungen öffnen",
  "settings_connected": "Verbunden",
  "settings_not_connected": "Getrennt",
  "settings_sync_range": "Synchronisierungsbereich",

  // Google Calendar page
  "calendar_page_title": "Kalender",
  "calendar_page_desc": "Google Calendar synchronisieren, um Besprechungspläne zu erhalten und Erinnerungen zu empfangen",
  "calendar_connection_status": "Google Calendar Verbindungsstatus",
  "calendar_not_connected": "Nicht verbunden",
  "calendar_not_connected_desc": "Google Calendar verbinden, um bevorstehende Meetings anzuzeigen",
  "calendar_connected": "Verbunden",
  "calendar_connect_button": "Google Calendar verbinden",
  "calendar_disconnect_button": "Trennen",
  "calendar_privacy_note": "Wir lesen nur Ihre Kalendereinträge. Wir ändern, erstellen oder löschen keine Inhalte",
  "calendar_learn_more": "Mehr erfahren",
  "calendar_sync_settings": "Synchronisierungseinstellungen",
  "calendar_auto_sync": "Automatische Synchronisierung",
  "calendar_auto_sync_desc": "Besprechungen regelmäßig aus Google Calendar synchronisieren",
  "calendar_sync_frequency": "Synchronisierungshäufigkeit",
  "calendar_sync_frequency_desc": "In festgelegten Intervallen automatisch synchronisieren",
  "calendar_sync_range": "Synchronisierungsbereich",
  "calendar_sync_range_desc": "Nur Besprechungen innerhalb des angegebenen zukünftigen Bereichs synchronisieren",
  "calendar_sync_content": "Zu synchronisierende Inhalte",
  "calendar_content_title": "Besprechungstitel",
  "calendar_content_time": "Start- und Endzeit",
  "calendar_content_link": "Google Meet Link",
  "calendar_content_attendees": "Teilnehmerinformationen",
  "calendar_content_location": "Besprechungsort",
  "calendar_tip": "Tipp: Nach der Verbindung erhalten Sie Systembenachrichtigungen vor bevorstehenden Meetings",
  "calendar_frequency_15min": "15 Minuten",
  "calendar_frequency_30min": "30 Minuten",
  "calendar_frequency_1hour": "1 Stunde",
  "calendar_frequency_2hours": "2 Stunden",
  "calendar_range_7days": "Nächste 7 Tage",
  "calendar_range_14days": "Nächste 14 Tage",
  "calendar_range_30days": "Nächste 30 Tage",
  "calendar_range_60days": "Nächste 60 Tage",
  "calendar_reminders": "Meeting-Erinnerungen",
  "calendar_reminders_enable": "Meeting-Erinnerungen aktivieren",
  "calendar_reminders_enable_desc": "Systembenachrichtigungen vor Meetings senden",
  "calendar_reminders_advance": "Vorlaufzeit der Erinnerung",
  "calendar_reminders_advance_desc": "Wie viele Minuten vor dem Meeting eine Benachrichtigung senden",
  "calendar_reminder_on_time": "Zum Besprechungsbeginn",
  "calendar_reminder_5min": "5 Minuten vorher",
  "calendar_reminder_10min": "10 Minuten vorher",
  "calendar_reminder_15min": "15 Minuten vorher",
  "calendar_reminder_30min": "30 Minuten vorher",
  "calendar_test_notif": "Test-Benachrichtigung",
  "calendar_test_notif_desc": "Sofort eine Testerinnerung senden, um Benachrichtigungen zu überprüfen",
  "calendar_test_notif_btn": "Test senden",
  "calendar_test_notif_success": "Test-Benachrichtigung gesendet, prüfen Sie Ihre Systembenachrichtigungen",
  "calendar_test_notif_fail": "Senden fehlgeschlagen, bitte Benachrichtigungsberechtigung prüfen",
  "calendar_sync_status": "Synchronisierungsstatus",
  "calendar_last_sync": "Letzte Synchronisierung: {time}",
  "calendar_sync_now": "Jetzt synchronisieren",
  "calendar_syncing": "Synchronisierung läuft...",
  "calendar_sync_success": "Synchronisierung erfolgreich, <strong>{n}</strong> Kalendereinträge abgerufen",
  "calendar_sync_error_default": "Synchronisierung fehlgeschlagen, bitte erneut versuchen",
  "calendar_syncing_msg": "Einträge aus Google Calendar werden abgerufen...",
  "calendar_event_no_title": "(Kein Titel)",
  "calendar_event_attendees": "{n} Teilnehmer",
  "calendar_meet_link": "Meet-Link",
  "calendar_event_more": "{n} weitere Einträge",
  "calendar_sync_empty": "Klicken Sie auf 'Jetzt synchronisieren', um bevorstehende Meetings abzurufen",
  "settings_local_data": "Lokale Daten",
  ...
  "notif_reminder_title": "Meeting-Erinnerung",
  "notif_starting_now": "Das Meeting beginnt jetzt",
  "notif_starts_in": "Beginnt in {n} Minuten",
  "notif_start_time": "Startzeit: {time}",
  "notif_click_to_join": "Klicken, um dem Meeting beizutreten",
  "notif_join_btn": "Meeting beitreten",
  "notif_test_title": "📅 Test-Meeting-Erinnerung",
};
