export default {
  ...
  // Options tabs
  "tab_ai_models_nav": "AIモデル",
  "tab_visibility": "表示設定",
  "tab_translation": "翻訳",
  "tab_translation_nav": "翻訳",
  "tab_other": "その他",
  "tab_calendar": "Google Calendar",
  "tab_data_sync": "ミーティング履歴",
  "tab_google_drive": "Google Drive",
  // Extension section
  "extension_section": "拡張機能",
  "enable_extension": "拡張機能を有効にする",
  "extension_active_desc": "Google Meetでキャプション収集が有効です",
  "extension_paused_desc": "拡張機能が一時停止中 — キャプションは収集されません",
  "extension_toggle_footer": "拡張機能をアンインストールせずにキャプション収集を一時停止または再開するにはトグルしてください。",

  // Popup tabs
  "popup_tab_meetings": "ミーティング",
  "popup_tab_live": "進行中",
  "popup_tab_ai": "AI",
  "popup_tab_settings": "設定",
  "ai_no_content_title": "まだミーティングコンテンツがありません",
  "ai_no_content_sub": "ミーティング後、要約とAIインサイトがここに表示されます。",
  "ai_whats_coming": "提供される機能",
  "ai_feature_summaries": "AI生成サマリー",
  "ai_feature_highlights": "重要ポイントとアクションアイテム",
  "ai_feature_ask_meetings": "ミーティングについて何でも質問できます",
  "ai_recent_meetings": "最近のミーティング",
  "ai_ask_ai_btn": "AIに質問",
  "ai_view_all_meetings": "すべてのミーティングとサマリーを表示",
  "meetings_connect_title": "今後のGoogle Meetミーティングを確認",
  "meetings_connect_sub": "Google Calendarを接続して、今後のミーティングを確認し、リマインダーを受け取りましょう。",
  "meetings_connect_note": "🔒 読み取り専用アクセス。データはプライベートです。",
  "meetings_no_upcoming_title": "今後のミーティングはありません",
  "meetings_no_upcoming_sub": "カレンダーは空です。良い一日を！",
  "meetings_open_calendar_settings": "カレンダー設定を開く",
  "meetings_today_label": "今日 · {date}",
  "meetings_synced_now": "たった今同期しました",
  "meetings_sync_ago": "{time}前に同期",
  "meetings_sync_h": "時間",
  "meetings_sync_m": "分",
  "meetings_sync_s": "秒",
  "meetings_in_progress": "進行中",
  "meetings_starts_in": "{min}分後に開始",
  "meetings_untitled": "無題のミーティング",
  "meetings_participants": "{n}人の参加者",
  "meetings_join_btn": "ミーティングに参加",
  "meetings_later_today": "今日の後ほど",
  "meetings_view_schedule": "全スケジュールを表示",
  "live_no_meeting_title": "ライブミーティングが検出されませんでした",
  "live_no_meeting_sub": "Google Meetミーティングに参加して、ライブキャプションと翻訳ステータスを確認してください。",
  "live_how_it_works": "使い方",
  "live_how_body": "Google Meetに参加すると自動的に検出し、キャプションのキャプチャを開始します。",
  "live_meet_detected": "Google Meetを検出しました",
  "live_now": "ライブ中",
  "live_captions_label": "キャプション",
  "live_active": "アクティブ",
  "live_translation_label": "翻訳",
  "live_translation_active": "アクティブ (EN → {lang})",
  "live_off": "オフ",
  "live_open_panel_btn": "ライブパネルを開く",
  "live_hint": "翻訳を設定で管理する",
  "live_manage_settings": "設定で管理 ›",

  // Settings tab
  "settings_open_full": "完全な設定を開く",
  "settings_connected": "接続済み",
  "settings_not_connected": "未接続",
  "settings_sync_range": "同期範囲",

  // Google Calendar page
  "calendar_page_title": "カレンダー",
  "calendar_page_desc": "Google カレンダーを同期して、会議スケジュールを取得しリマインダーを受信する",
  "calendar_connection_status": "Google カレンダー接続状態",
  "calendar_not_connected": "未接続",
  "calendar_not_connected_desc": "Google カレンダーを接続して、今後の会議を確認する",
  "calendar_connected": "接続済み",
  "calendar_connect_button": "Google カレンダーを接続",
  "calendar_disconnect_button": "切断",
  "calendar_privacy_note": "カレンダーイベントの読み取りのみ行います。コンテンツの変更・作成・削除は行いません",
  "calendar_learn_more": "詳細",
  "calendar_sync_settings": "同期設定",
  "calendar_auto_sync": "自動同期",
  "calendar_auto_sync_desc": "Google カレンダーから最新の会議を定期的に同期する",
  "calendar_sync_frequency": "同期頻度",
  "calendar_sync_frequency_desc": "設定した間隔で自動同期する",
  "calendar_sync_range": "同期範囲",
  "calendar_sync_range_desc": "指定した未来の範囲内の会議のみ同期する",
  "calendar_sync_content": "同期するコンテンツ",
  "calendar_content_title": "会議タイトル",
  "calendar_content_time": "開始時刻と終了時刻",
  "calendar_content_link": "Google Meet リンク",
  "calendar_content_attendees": "参加者情報",
  "calendar_content_location": "会議場所",
  "calendar_tip": "ヒント：接続後、今後の会議の前にシステム通知が届きます",
  "calendar_frequency_15min": "15分",
  "calendar_frequency_30min": "30分",
  "calendar_frequency_1hour": "1時間",
  "calendar_frequency_2hours": "2時間",
  "calendar_range_7days": "今後7日間",
  "calendar_range_14days": "今後14日間",
  "calendar_range_30days": "今後30日間",
  "calendar_range_60days": "今後60日間",
  "calendar_reminders": "会議リマインダー",
  "calendar_reminders_enable": "会議リマインダーを有効にする",
  "calendar_reminders_enable_desc": "会議開始前にシステム通知を送信する",
  "calendar_reminders_advance": "事前リマインダー時間",
  "calendar_reminders_advance_desc": "会議の何分前に通知を送信するか",
  "calendar_reminder_on_time": "会議開始時に通知",
  "calendar_reminder_5min": "5分前",
  "calendar_reminder_10min": "10分前",
  "calendar_reminder_15min": "15分前",
  "calendar_reminder_30min": "30分前",
  "calendar_test_notif": "テスト通知",
  "calendar_test_notif_desc": "通知が機能しているか確認するためにテストリマインダーをすぐに送信する",
  "calendar_test_notif_btn": "テスト送信",
  "calendar_test_notif_success": "テスト通知が送信されました。システム通知を確認してください",
  "calendar_test_notif_fail": "送信に失敗しました。通知権限が付与されているか確認してください",
  "calendar_sync_status": "同期ステータス",
  "calendar_last_sync": "最終同期: {time}",
  "calendar_sync_now": "今すぐ同期",
  "calendar_syncing": "同期中...",
  "calendar_sync_success": "同期成功、<strong>{n}</strong> 件のカレンダーイベントを取得しました",
  "calendar_sync_error_default": "同期失敗。再試行してください",
  "calendar_syncing_msg": "Google カレンダーからイベントを取得中...",
  "calendar_event_no_title": "(タイトルなし)",
  "calendar_event_attendees": "{n} 名の参加者",
  "calendar_meet_link": "Meet リンク",
  "calendar_event_more": "他 {n} 件のイベント",
  "calendar_sync_empty": "今すぐ同期をクリックして今後の会議を取得する",
  "settings_local_data": "ローカルデータ",
