export default {
  ...
  "tab_translation_nav": "Tradução",
  "tab_other": "Outros",
  "tab_calendar": "Google Calendar",
  "tab_data_sync": "Histórico de reuniões",
  "tab_google_drive": "Google Drive",
  // Extension section
  "extension_section": "Extensão",
  "enable_extension": "Ativar extensão",
  "extension_active_desc": "Captura de legendas ativa no Google Meet",
  "extension_paused_desc": "Extensão pausada — nenhuma legenda será capturada",
  "extension_toggle_footer": "Ative ou desative para pausar ou retomar a captura de legendas sem desinstalar a extensão.",

  // Popup tabs
  "popup_tab_meetings": "Reuniões",
  "popup_tab_live": "Em andamento",
  "popup_tab_ai": "IA",
  "popup_tab_settings": "Configurações",
  "ai_no_content_title": "Nenhum conteúdo de reunião ainda",
  "ai_no_content_sub": "Seus resumos de reuniões e insights de IA aparecerão aqui após suas reuniões.",
  "ai_whats_coming": "O que você obterá",
  "ai_feature_summaries": "Resumos gerados por IA",
  "ai_feature_highlights": "Pontos principais e itens de ação",
  "ai_feature_ask_meetings": "Pergunte qualquer coisa sobre suas reuniões",
  "ai_recent_meetings": "Reuniões recentes",
  "ai_ask_ai_btn": "Perguntar à IA",
  "ai_view_all_meetings": "Ver todas as reuniões e resumos",
  "meetings_connect_title": "Veja suas próximas reuniões do Google Meet",
  "meetings_connect_sub": "Conecte seu Google Calendar para ver as próximas reuniões e receber lembretes.",
  "meetings_connect_note": "🔒 Acesso somente leitura. Seus dados são privados.",
  "meetings_no_upcoming_title": "Sem reuniões próximas",
  "meetings_no_upcoming_sub": "Seu calendário está livre. Aproveite seu dia!",
  "meetings_open_calendar_settings": "Abrir configurações do calendário",
  "meetings_today_label": "Hoje · {date}",
  "meetings_synced_now": "Sincronizado agora",
  "meetings_sync_ago": "Sincronizado há {time}",
  "meetings_sync_h": "h",
  "meetings_sync_m": "min",
  "meetings_sync_s": "s",
  "meetings_in_progress": "Em andamento",
  "meetings_starts_in": "Começa em {min} min",
  "meetings_untitled": "Reunião sem título",
  "meetings_participants": "{n} participantes",
  "meetings_join_btn": "Participar da reunião",
  "meetings_later_today": "Mais tarde hoje",
  "meetings_view_schedule": "Ver agenda completa",
  "live_no_meeting_title": "Nenhuma reunião ao vivo detectada",
  "live_no_meeting_sub": "Entre em uma reunião do Google Meet para ver legendas ao vivo e o status de tradução.",
  "live_how_it_works": "Como funciona",
  "live_how_body": "Detectaremos automaticamente quando você estiver no Google Meet e começaremos a capturar legendas.",
  "live_meet_detected": "Google Meet detectado",
  "live_now": "Ao vivo agora",
  "live_captions_label": "Legendas",
  "live_active": "Ativo",
  "live_translation_label": "Tradução",
  "live_translation_active": "Ativo (EN → {lang})",
  "live_off": "Desativado",
  "live_open_panel_btn": "Abrir painel ao vivo",
  "live_hint": "Gerenciar tradução nas configurações",
  "live_manage_settings": "Gerenciar em Configurações ›",

  // Settings tab
  "settings_open_full": "Abrir configurações completas",
  "settings_connected": "Conectado",
  "settings_not_connected": "Desconectado",
  "settings_sync_range": "Intervalo de sincronização",

  // Google Calendar page
  "calendar_page_title": "Calendário",
  "calendar_page_desc": "Sincronize o Google Calendar para obter horários de reuniões e receber lembretes",
  "calendar_connection_status": "Status de conexão do Google Calendar",
  "calendar_not_connected": "Não conectado",
  "calendar_not_connected_desc": "Conecte seu Google Calendar para ver as reuniões futuras",
  "calendar_connected": "Conectado",
  "calendar_connect_button": "Conectar Google Calendar",
  "calendar_disconnect_button": "Desconectar",
  "calendar_privacy_note": "Apenas lemos seus eventos do calendário. Não modificaremos, criaremos ou excluiremos nenhum conteúdo",
  "calendar_learn_more": "Saiba mais",
  "calendar_sync_settings": "Configurações de sincronização",
  "calendar_auto_sync": "Sincronização automática",
  "calendar_auto_sync_desc": "Sincronizar periodicamente as últimas reuniões do Google Calendar",
  "calendar_sync_frequency": "Frequência de sincronização",
  "calendar_sync_frequency_desc": "Sincronização automática em intervalos definidos",
  "calendar_sync_range": "Intervalo de sincronização",
  "calendar_sync_range_desc": "Sincronizar apenas reuniões no intervalo futuro especificado",
  "calendar_sync_content": "Conteúdo para sincronizar",
  "calendar_content_title": "Título da reunião",
  "calendar_content_time": "Horário de início e término",
  "calendar_content_link": "Link do Google Meet",
  "calendar_content_attendees": "Informações dos participantes",
  "calendar_content_location": "Local da reunião",
  "calendar_tip": "Dica: após conectar, você receberá notificações do sistema antes das próximas reuniões",
  ...
  "calendar_range_7days": "Próximos 7 dias",
  "calendar_range_14days": "Próximos 14 dias",
  "calendar_range_30days": "Próximos 30 dias",
  "calendar_range_60days": "Próximos 60 dias",
  "calendar_reminders": "Lembretes de reuniões",
  "calendar_reminders_enable": "Ativar lembretes de reuniões",
  "calendar_reminders_enable_desc": "Enviar notificações do sistema antes do início das reuniões",
  "calendar_reminders_advance": "Tempo de antecedência do lembrete",
  "calendar_reminders_advance_desc": "Quantos minutos antes da reunião enviar a notificação",
  "calendar_reminder_on_time": "Na hora da reunião",
  ...
  "calendar_test_notif": "Notificação de teste",
  "calendar_test_notif_desc": "Enviar imediatamente um lembrete de teste para verificar se as notificações funcionam",
  "calendar_test_notif_btn": "Enviar teste",
  "calendar_test_notif_success": "Notificação de teste enviada, verifique as notificações do sistema",
  "calendar_test_notif_fail": "Falha ao enviar, confirme se a permissão de notificação foi concedida",
  "calendar_sync_status": "Status de sincronização",
  "calendar_last_sync": "Última sincronização: {time}",
  "calendar_sync_now": "Sincronizar agora",
  "calendar_syncing": "Sincronizando...",
  "calendar_sync_success": "Sincronização bem-sucedida, <strong>{n}</strong> eventos do calendário obtidos",
  "calendar_sync_error_default": "Falha na sincronização, tente novamente",
  "calendar_syncing_msg": "Obtendo eventos do Google Calendar...",
  "calendar_event_no_title": "(Sem título)",
  "calendar_event_attendees": "{n} participantes",
  "calendar_meet_link": "Link Meet",
  "calendar_event_more": "{n} mais eventos",
  "calendar_sync_empty": "Clique em Sincronizar agora para obter as próximas reuniões",
  ...
  "notif_reminder_title": "Lembrete de reunião",
  "notif_starting_now": "A reunião está começando",
  "notif_starts_in": "Começa em {n} minutos",
  "notif_start_time": "Hora de início: {time}",
  "notif_click_to_join": "Clique para entrar na reunião",
  "notif_join_btn": "Entrar na reunião",
  "notif_test_title": "📅 Lembrete de reunião de teste",
};
