export default {
  ...
  "tab_ai_models": "서비스 모델",
  "tab_ai_prompts": "프롬프트 라이브러리",
  "tab_translation_prefs": "번역 환경설정",
  "tab_general": "일반",
  "tab_general_desc": "언어, 글꼴 크기, 도움말 및 데이터 관리",
  "tab_interface": "인터페이스",
  "tab_interface_desc": "사이드패널 탭, 자막 버튼, 회의 오버레이 및 하이라이트 단어",
  "tab_history": "캘린더",
  "tab_history_desc": "회의 기록, AI 어시스턴트 및 내보내기",
  "tab_cloud_sync": "클라우드",
  "tab_cloud_sync_desc": "Google Drive 백업 및 복원",
  "meeting_history_tab": "회의 기록",
  "ai_assistant_tab": "AI 어시스턴트",
  "ai_chat_title": "AI 회의 어시스턴트",
  "ai_chat_empty_desc": "날짜 범위를 선택하면 해당 기간의 회의 기록을 기반으로 대화를 시작할 수 있습니다",
  "ai_reading_records": "회의 기록을 불러오는 중",
  ...
  "preset_2m": "최근 2개월",
  "preset_3m": "최근 3개월",
  "preset_custom": "사용자 지정 범위",
  "date_format_short": "M월 D일",
  "capsule_text": "{start} - {end} ({count}개 기록)",
  "clear_chat": "채팅 지우기",
  "no_ai_provider_before": "AI 서비스가 설정되지 않았습니다,",
  "no_ai_provider_link": "AI 설정으로 이동",
  "no_ai_provider_after": "하여 서비스 제공자를 설정하세요.",
  "placeholder_no_date": "먼저 날짜 범위를 선택해 주세요...",
  "placeholder_no_provider": "먼저 AI 서비스를 설정해 주세요...",
  "ai_input_placeholder": "질문을 입력하세요, Cmd+Enter 또는 Ctrl+Enter을 눌러 빠르게 보내기",
  "select_ai_service": "AI 서비스 선택",
  "default_label": "기본값",
  "current_provider": "현재: {name}",
  "select_ai": "AI 선택",

  // Shared UI (General tab)
  "help_and_guide": "도움말 및 가이드",
  "open_welcome_guide": "시작 가이드 열기",
  "ui_language_selector_desc": "확장 프로그램 인터페이스 언어 선택",
  "data_management": "데이터 관리",
  "highlight_words_section": "자막 하이라이트",

  // Options tabs
  "tab_ai_models_nav": "AI 모델",
  "tab_visibility": "표시 설정",
  "tab_translation": "번역",
  "tab_translation_nav": "번역",
  "tab_other": "기타",
  "tab_calendar": "Google Calendar",
  "tab_data_sync": "미팅 기록",
  "tab_google_drive": "Google Drive",
  // Extension section
  "extension_section": "확장 프로그램",
  "enable_extension": "확장 프로그램 활성화",
  "extension_active_desc": "Google Meet에서 자막 캡처가 활성화되어 있습니다",
  "extension_paused_desc": "확장 프로그램이 일시 중지됨 — 자막이 캡처되지 않습니다",
  "extension_toggle_footer": "확장 프로그램을 제거하지 않고 자막 캡처를 일시 중지하거나 재개하려면 토글하세요.",

  // Popup tabs
  "popup_tab_meetings": "미팅",
  "popup_tab_live": "진행 중",
  "popup_tab_ai": "AI",
  "popup_tab_settings": "설정",
  "ai_no_content_title": "아직 미팅 콘텐츠가 없습니다",
  "ai_no_content_sub": "미팅 후 여기에 요약과 AI 인사이트가 표시됩니다.",
  "ai_whats_coming": "제공되는 기능",
  "ai_feature_summaries": "AI 생성 요약",
  "ai_feature_highlights": "주요 내용 및 실행 항목",
  "ai_feature_ask_meetings": "미팅에 관해 무엇이든 질문하세요",
  "ai_recent_meetings": "최근 미팅",
  "ai_ask_ai_btn": "AI에게 물어보기",
  "ai_view_all_meetings": "모든 미팅 및 요약 보기",
  "meetings_connect_title": "예정된 Google Meet 미팅 보기",
  "meetings_connect_sub": "Google Calendar를 연결하여 예정된 미팅을 확인하고 알림을 받으세요.",
  "meetings_connect_note": "🔒 읽기 전용 액세스. 데이터는 비공개입니다.",
  "meetings_no_upcoming_title": "예정된 미팅이 없습니다",
  "meetings_no_upcoming_sub": "캘린더가 비어 있습니다. 좋은 하루 되세요!",
  "meetings_open_calendar_settings": "캘린더 설정 열기",
  "meetings_today_label": "오늘 · {date}",
  "meetings_synced_now": "방금 동기화됨",
  "meetings_sync_ago": "{time} 전 동기화",
  "meetings_sync_h": "시간",
  "meetings_sync_m": "분",
  "meetings_sync_s": "초",
  "meetings_in_progress": "진행 중",
  "meetings_starts_in": "{min}분 후 시작",
  "meetings_untitled": "제목 없는 미팅",
  "meetings_participants": "{n}명 참가자",
  "meetings_join_btn": "미팅 참가",
  "meetings_later_today": "오늘 나중에",
  "meetings_view_schedule": "전체 일정 보기",
  "live_no_meeting_title": "라이브 미팅이 감지되지 않았습니다",
  "live_no_meeting_sub": "라이브 자막 및 번역 상태를 보려면 Google Meet 미팅에 참가하세요.",
  "live_how_it_works": "작동 방식",
  "live_how_body": "Google Meet에 참가할 때 자동으로 감지하고 자막 캡처를 시작합니다.",
  "live_meet_detected": "Google Meet 감지됨",
  "live_now": "지금 라이브",
  "live_captions_label": "자막",
  "live_active": "활성",
  "live_translation_label": "번역",
  "live_translation_active": "활성 (EN → {lang})",
  "live_off": "끔",
  "live_open_panel_btn": "라이브 패널 열기",
  "live_hint": "설정에서 번역 관리",
  "live_manage_settings": "설정에서 관리 ›",

  // Settings tab
  "settings_open_full": "전체 설정 열기",
  "settings_connected": "연결됨",
  "settings_not_connected": "연결 안 됨",
  "settings_sync_range": "동기화 범위",

  // Google Calendar page
  "calendar_page_title": "캘린더",
  "calendar_page_desc": "Google 캘린더를 동기화하여 회의 일정을 확인하고 알림을 받으세요",
  "calendar_connection_status": "Google 캘린더 연결 상태",
  "calendar_not_connected": "연결되지 않음",
  "calendar_not_connected_desc": "예정된 회의를 보려면 Google 캘린더를 연결하세요",
  "calendar_connected": "연결됨",
  "calendar_connect_button": "Google 캘린더 연결",
  "calendar_disconnect_button": "연결 해제",
  "calendar_privacy_note": "캘린더 이벤트를 읽기만 합니다. 콘텐츠를 수정, 생성 또는 삭제하지 않습니다",
  "calendar_learn_more": "자세히 알아보기",
  "calendar_sync_settings": "동기화 설정",
  "calendar_auto_sync": "자동 동기화",
  "calendar_auto_sync_desc": "Google 캘린더에서 최신 회의를 주기적으로 동기화",
  "calendar_sync_frequency": "동기화 빈도",
  "calendar_sync_frequency_desc": "설정된 간격으로 자동 동기화",
  "calendar_sync_range": "동기화 범위",
  "calendar_sync_range_desc": "지정된 미래 범위 내의 회의만 동기화",
  "calendar_sync_content": "동기화할 내용",
  "calendar_content_title": "회의 제목",
  "calendar_content_time": "시작 및 종료 시간",
  "calendar_content_link": "Google Meet 링크",
  "calendar_content_attendees": "참석자 정보",
  "calendar_content_location": "회의 장소",
  "calendar_tip": "팁: 연결 후 예정된 회의 전에 시스템 알림을 받게 됩니다",
  "calendar_frequency_15min": "15분",
  "calendar_frequency_30min": "30분",
  "calendar_frequency_1hour": "1시간",
  "calendar_frequency_2hours": "2시간",
  "calendar_range_7days": "다음 7일",
  "calendar_range_14days": "다음 14일",
  "calendar_range_30days": "다음 30일",
  "calendar_range_60days": "다음 60일",
  "calendar_reminders": "회의 알림",
  "calendar_reminders_enable": "회의 알림 활성화",
  "calendar_reminders_enable_desc": "회의 시작 전에 시스템 알림 보내기",
  "calendar_reminders_advance": "사전 알림 시간",
  "calendar_reminders_advance_desc": "회의 몇 분 전에 알림을 보낼지 설정",
  "calendar_reminder_on_time": "회의 시작 시에",
  "calendar_reminder_5min": "5분 전",
  "calendar_reminder_10min": "10분 전",
  "calendar_reminder_15min": "15분 전",
  "calendar_reminder_30min": "30분 전",
  "calendar_test_notif": "테스트 알림",
  "calendar_test_notif_desc": "알림이 작동하는지 확인하기 위해 즉시 테스트 알림 보내기",
  "calendar_test_notif_btn": "테스트 보내기",
  "calendar_test_notif_success": "테스트 알림이 전송되었습니다. 시스템 알림을 확인하세요",
  "calendar_test_notif_fail": "전송 실패, 알림 권한이 부여되었는지 확인하세요",
  "calendar_sync_status": "동기화 상태",
  "calendar_last_sync": "마지막 동기화: {time}",
  "calendar_sync_now": "지금 동기화",
  "calendar_syncing": "동기화 중...",
  "calendar_sync_success": "동기화 성공, <strong>{n}</strong>개의 캘린더 이벤트를 가져왔습니다",
  "calendar_sync_error_default": "동기화 실패, 다시 시도해 주세요",
  "calendar_syncing_msg": "Google 캘린더에서 이벤트를 가져오는 중...",
  "calendar_event_no_title": "(제목 없음)",
  "calendar_event_attendees": "참석자 {n}명",
  "calendar_meet_link": "Meet 링크",
  "calendar_event_more": "{n}개 이벤트 더 보기",
  "calendar_sync_empty": "예정된 회의를 가져오려면 지금 동기화를 클릭하세요",
  "settings_local_data": "로컬 데이터",
